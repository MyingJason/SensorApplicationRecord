...
public class RecordAudioTask extends AsyncTask<AudioClipListener, Void, Boolean>
{
    ...
    public RecordAudioTask(TextView log, String taskName)
    {
        this.log = log;
    ...
    protected Boolean doInBackground(AudioClipListener... listeners)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                heard =
                        recorder.startRecordingForTime(1500, AudioClipRecorder.RECORDER_SAMPLERATE_8000, AudioFormat.ENCODING_PCM_16BIT);
                break;
